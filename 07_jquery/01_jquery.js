...
// ---------------------------------------------------------------
// todo attr('속성', '속성값') : 요소의 속성을 추가, 수정, 가져오기
function useAttr() {
...
// todo text() : 요소의 content 중 text만 가져오거나 수정
function useText() {
...
// todo html() : 요소의 content(html 형식)을 가져오거나 수정
function useHtml() {
...
// todo 요소 변경 : append(), prepend(), before(), after()
function useAppend() {
...
// ---------------------------------------------------------
//  todo 요소변경: parent(). parents(), next(), prev(), children()
...
// todo 클래스 조작 :  addClass(), removeClass(), hasClass(), toggleClass()
